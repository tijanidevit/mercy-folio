<template>
  <Layout pageTitle="Adekunjo Mercy" pageSubtitle="I am a final year student of Computer Science. I love tech!">
    <div class="section">
      <div class="container">
        <div class="columns">
              ...
              <div class="card-content">
                <div class="media">
                  <div class="media-content">
                    ...
                    <p style="display:none;" class="subtitle is-7">
                ...
                <div>
                  <span  style="display:none;" v-for="(tag, index) in edge.node.tags" :key="tag.id">
                    <div class="tag">
                      <g-link :to="tag.path">
                        {{ tag.id }}
                      </g-link>
